...
$envFrameSrc = getenv('TYPO3_ANALYTICS_ADDITIONAL_FRAME_SRC');
$additionalFrameSrc = ($envFrameSrc !== false && $envFrameSrc !== '')
    ? $envFrameSrc
    : (string)($GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['analytics']['additionalFrameSrc'] ?? '');
